...
xPropertyWidget::xPropertyWidget( QWidget *parent ) :
...
void xPropertyWidget::displayNodeProperties(osg::Node *node)
{
    if (!node)
        return;
...
void xPropertyWidget::displayLODProperties(osg::LOD *node)
{
    if (!node)
        return;
...
void xPropertyWidget::displaySwitchProperties(osg::Switch *node)
{
    if (!node)
        return;
...
void xPropertyWidget::displayGeodeProperties(osg::Geode *node)
{
    if (!node)
        return;
...
void xPropertyWidget::displayBaseStats(osg::Node *node)
{
    // setup global stats
