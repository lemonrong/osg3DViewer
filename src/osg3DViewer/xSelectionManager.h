...
protected:
    osg::ref_ptr<osg::Node> m_selectedNode;    //!< Selected node
    osg::ref_ptr<osg::Geometry> m_selectedGeometry;    //!< Selected geometry
    osg::ref_ptr<xSelectionDecorator> m_selectionDecorator;    //!< Decorator node for highlighting
};
